            ...
            <React.Fragment>
                <table className='AddClient'>
                    ...
                    <tbody>
                        <tr>
                            <td>Фамилия: </td>
                            <td><input name='fam' type="text" defaultValue='' ref={this.setСlientFamRef} /></td>
                        </tr>
                        <tr>
                            <td>Имя: </td>
                            <td><input name='im' type="text" defaultValue='' ref={this.setСlientImRef} /></td>
                        </tr>
                        <tr>
                            <td>Отчество: </td>
                            <td><input name='otch' type="text" defaultValue=''  ref={this.setСlientOtchRef} /></td>
                        </tr>
                        <tr>
                            <td>Баланс: </td>
                            <td><input name='balance' type="text" defaultValue=''  ref={this.setСlientBalanceRef} /></td>
                        </tr>
                        <tr>
                            <td colSpan="2" className="AddClient__buttons">
                                <input name="save-button" type="button" value="Сохранить" onClick={this.emitSaveButtonClicked} />
                                <input name="close-button" type="button" value="Закрыть" onClick={this.emitCancelButtonClicked} />
                            </td>
                        </tr>
                    </tbody>
                </table>
