...
class EditClient extends React.PureComponent {
    ...
    emitSaveButtonClicked = () => { //кнопка "Сохранить" кликнута - событие словит handler в MobileCompany
        ...
        buttonsEvents.emit('editClientSaveButtonClicked', refs);
    };
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colSpan="2" className="EditClient__buttons">
                                <input name="save-button2" type="button" value="Сохранить" onClick={this.emitSaveButtonClicked} />
                                <input name="close-button2" type="button" value="Закрыть" onClick={this.emitCancelButtonClicked} />
                            </td>
                        </tr>
                    </tbody>
                </table>
